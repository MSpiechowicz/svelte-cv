<script lang="ts">
  let { fillColor = 'currentColor', customClass = '' } = $props();
</script>
...
>
	<g>
		<g>
			<path
				d="M145.1,229.6c17.2,56.4,61.4,115,121,115s103.9-58.6,121-115c14.7-5.1,27-19.8,31.801-38.8c6.6-26.1-3.101-50.3-21.9-57.6
			...
			/>
			<path
				d="M383.599,299.4c-12.8,21.8-27.6,40.3-47.3,50.199c-40.5,20.7-70.6,37.5-70.6,37.5l-0.1-0.1v-0.5l-0.5,0.2l-0.5-0.2v0.5
